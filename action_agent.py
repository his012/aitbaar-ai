...
# 4. Gets API key from os.environ["GEMINI_API_KEY_ACTION"]
if "GEMINI_API_KEY_ACTION" in os.environ:
    client = genai.Client(api_key=os.environ["GEMINI_API_KEY_ACTION"])
else:
    print("Warning: GEMINI_API_KEY_ACTION not found in environment variables.")
    client = None
